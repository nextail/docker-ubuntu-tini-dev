...
FROM nextail/ubuntu-tini-user:24.04
...
COPY --from=nextail/ubuntu-openssl-old:24.04 ${OPENSSL_ROOT_1_0} ${OPENSSL_ROOT_1_0}
# Install OpenSSL 1.0
RUN <<EOT
...
COPY --from=nextail/ubuntu-openssl-old:24.04 ${OPENSSL_ROOT_1_1} ${OPENSSL_ROOT_1_1}
# Install OpenSSL 1.1
RUN <<EOT
