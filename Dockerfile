...
FROM nextail/ubuntu-tini-user:22.04
...
COPY --from=nextail/ubuntu-openssl-old:22.04 ${OPENSSL_ROOT_1_0} ${OPENSSL_ROOT_1_0}
# Install OpenSSL 1.0
RUN <<EOT
...
COPY --from=nextail/ubuntu-openssl-old:22.04 ${OPENSSL_ROOT_1_1} ${OPENSSL_ROOT_1_1}
# Install OpenSSL 1.1
RUN <<EOT
