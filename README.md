...
This is a Docker image based on [nextail/ubuntu-tini-user](https://github.com/nextail/docker-ubuntu-tini-user) 18.04 and includes various development tools.  This image includes [old openssl](https://www.openssl.org/source/old/) version builds from [nextail/ubuntu-openssl-old](https://github.com/nextail/docker-ubuntu-openssl-old) to allow old Ruby versions to be installed.
